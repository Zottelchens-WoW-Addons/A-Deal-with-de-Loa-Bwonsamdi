...
local voicelines = {
  ...
  { weight = 10, character = "Fyrakk",  type = "say",  id = 222437, text = "Haha! Fly away little dragons." },
  { weight = 10, character = "Fyrakk",  type = "say",  id = 222586, text = "Begone worms!" },
  { weight = 10, character = "Fyrakk",  type = "yell", id = 222497, text = "Weak playthings of the titans! Burn!" },
